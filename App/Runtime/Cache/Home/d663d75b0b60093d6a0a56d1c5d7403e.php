...
<html lang="zh-CN">
  <head>
    ...
    <title>企业登录-<?php echo ($sysInfo["title"]); ?></title>
    ...
    <div class="panel panel-default">
      <div class="panel-body" style="margin-top:100px;margin-bottom:100px;">
        <div class="login-title text-center">
          <h3>欢迎您登录IT招聘网~企业账号</h3>
        </div>
        <form action="<?php echo U('Home/Login/checkEnLogin');?>" method="post" class="col-md-offset-4 col-md-4">
          <div class="form-group">
            <div class="input-group">
              <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
              <input type="text" id="username" name="contact" class="form-control" value="" placeholder="请输入您的邮箱">
            </div>
          </div>
          <div class="form-group">
            <div class="input-group">
          ...
          <div class="form-group">
            <div class="col-md-6 link">
              <p class="text-center remove-margin"><small>忘记密码？</small> <a href="<?php echo U('Home/Register/retrieveEnPw');?>" ><small>找回</small></a>
              </p>
            </div>
            <div class="col-md-6 link">
              <p class="text-center remove-margin"><small>没有账号?</small> <a href="<?php echo U('Home/Register/enRegister');?>" ><small>马上注册</small></a>
              </p>
            </div>
          </div>
        </form>
